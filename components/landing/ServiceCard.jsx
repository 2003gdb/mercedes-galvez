...
export default function ServiceCard({ title, imageSrc, description, services, cuarzoSrc }) {
  ...
  return (
    <div className="min-h-[300px] md:h-[300px] perspective-1000 relative">
      ...
      <div className="absolute -top-15 left-1/2 transform -translate-x-1/2 w-24 h-24 z-10">
        <Image
      ...
      >
        ...
        <Card className="absolute inset-0 backface-hidden bg-white/20 backdrop-blur-sm pt-6">
          ...
          <div className="p-4 mt-4 flex flex-col h-full">
            <h3 className="text-xl mb-2" style={{ fontFamily: 'var(--font-lexend-mega)' }}>{title}</h3>
            <p className="text-md text-gray/70" style={{ fontFamily: 'var(--font-lexend-deca)', fontWeight: 200 }}>{description}</p>
            <div className="mt-auto">
              <p className="text-xs text-center text-muted-foreground md:hidden pt-2 border-t" style={{ fontFamily: 'var(--font-lexend-mega)' }}>
        ...
        <Card className="absolute inset-0 backface-hidden overflow-y-auto rotate-y-180 bg-white/20 backdrop-blur-sm p-3 md:p-5 shadow-lg">
          <div className="p-2 mt-2 flex flex-col h-full">
            <h4 className="text-lg mb-2 border-b pb-2" style={{ fontFamily: 'var(--font-lexend-mega)' }}>{title}</h4>
            <ul className="list-disc pl-4 md:pl-5 space-y-1 md:space-y-2 text-md flex-grow" style={{ fontFamily: 'var(--font-lexend-deca)', fontWeight: 200 }}>
